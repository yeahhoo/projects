...
<h1>Secured page</h1>
    <div class="container">
        The page must be secured, only registered users can see it.
        <div id="react-create-client-container"></div>
    </div>
    ...
    <script type="text/javascript" src="/client/components/js/compiled/react-create-client.js"></script>
</body>
</html>